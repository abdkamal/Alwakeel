...
نفس الرموز والمكوّنات. لا قائمة جانبية؛ شريط علوي بعنوان "مدير نظام الوكيل" وشارة الهيئة، وتبويبات علوية: الهيئة والهوية | الهيكلية | المكاتب والأجهزة | الحسابات والمفاتيح | تصدير الإعداد | الصيانة | السجل. محتوى بعرض كامل بحافة 28.

## المثبّت (720×520)

نافذة مثبّت كلاسيكية RTL: ترويسة بلون `$primary-fill` مع الشعار والاسم، محتوى أبيض، شريط أزرار سفلي (السابق يسارًا، التالي/تثبيت يمينًا)، شريط تقدم.
